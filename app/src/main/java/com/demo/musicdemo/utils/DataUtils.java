...
public class DataUtils {
    ...
    public static String getJsonFromAssets(Context context, String fileName) {
         ...
         * 2. AssetManager 资源管理器，Open 方法 打开指定的资源文件，返回 InputStream 输入流
         * 3. InputStreamReader （字节到字符的桥接器），BufferedReader （存放读取字符的缓冲区）
         * 4. 循环利用 BufferedReader 的 readLine 方法读取每一行的数据，并且把读取出来的数据
         *    放入到 StringBuilder 里面
         * 5. 返回读取出来的所有数据
         */
...
//        Open 方法 打开指定的资源文件，返回 InputStream 输入流
        try {
